...
[![Recorrido Museo Virtual](https://img.youtube.com/vi/3x-zCDBgkeA/maxresdefault.jpg)](https://youtu.be/3x-zCDBgkeA)

## 💡 El Motivo del Proyecto
Esta iniciativa busca ofrecer una solución innovadora ante la pasividad de los métodos tradicionales de aprendizaje de la historia[cite: 1]. El objetivo central es construir un entorno interactivo que rompa la pasividad contemplativa, transformando al espectador en un agente activo que explora de manera autónoma para generar un vínculo emocional y mejorar la retención de la información[cite: 1].

## ⚙️ Desarrollo Técnico
El entorno fue desarrollado íntegramente utilizando el motor gráfico Unity[cite: 1]. 
* **Arquitectura del Entorno:** Se modeló un espacio tridimensional que simula un espacio museístico ambientado en un lugar turístico representativo del Perú, estructurado como un pasillo secuencial[cite: 1]. 
* **Navegación:** Se implementó un sistema de movimiento básico que permite controlar a un personaje en primera persona utilizando teclado y mouse[cite: 1].
* **Interactividad:** La exhibición de los hitos históricos se realiza mediante paneles interactivos y recursos multimedia que responden a la proximidad del personaje o a la selección directa del usuario[cite: 1].
...
| | |
|:---:|:---:|
| ![Captura 1](Captura1.png) | ![Captura 2](Captura2.png) |
| ![Captura 3](Captura3.png) | ![Captura 4](Captura4.png) |
